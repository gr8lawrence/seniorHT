...
### Figure 2
```{r roc_curve_rocr}
pred <- prediction(prediction_list_single[[1]], truth_list_single[[1]])
...
```{r roc_curve}
roc1 <- plot.roc(truth_list_single[[1]], prediction_list_single[[1]], 
         main = "ROC Curves for Predictions \nRandom Forest + TSPs",
         cex.main = 1.05,
         #smooth = TRUE,
         col = "#E69F00")
lineobj1 <- lines.roc(truth_list_single[[4]], prediction_list_single[[4]],
                     #smooth = TRUE,
                     col = rainbow(5))
lineobj2 <- lines.roc(truth_list_combined[[5]], prediction_list_combined[[5]],
                     #smooth = TRUE,
                     col = "#56B4E9")
