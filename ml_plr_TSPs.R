...
write.table(learning.results, file = "/nas/longleaf/home/tianyi96/TSPs_plr_results.csv")

save(x = final_results, file = "TSPs_plr_results.Rdata")
save(x = final_preds, file = "TSPs_plr_predictions.Rdata")
save.image()
